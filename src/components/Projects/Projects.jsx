  ...
  const projects = [
    {
      ...
      projectUrl: "https://e-commerce-nine-kohl-13.vercel.app/",      // 👈 reemplazá
      codeUrl: "https://github.com/fidelgenre/E-Commerce"       // 👈 reemplazá
    },
    {
      ...
      image: "src/assets/StudentSystem.png",
      tags: ["React", "SpringBoot", "MongoDB"],
      projectUrl: "https://studentsystemf.onrender.com/",      // 👈 reemplazá
      codeUrl: "https://github.com/FidelGenre/StudentSystem"       // 👈 reemplazá
    },
    {
      title: "Project-3",
      description:
      ...
      image: "/code-editor-with-colorful-syntax-highlighting.jpg",
      tags: ["</>", "</>", "</>", "</>"],
      projectUrl: "https://your-live-project-url.com",      // 👈 reemplazá
      codeUrl: "https://github.com/tuusuario/tu-repo"       // 👈 reemplazá
    },
  ]
    ...
    <section id="projects" className={styles.projects}>
      <div className={styles.container}>
        ...
        <div className={styles.githubSection}>
          <button className={styles.githubButton}>See More on GitHub</button>
        </div>
      </div>
    </section>
  )

...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="animate-gradient-shift relative flex items-center justify-center overflow-x-hidden bg-[linear-gradient(135deg,#1a1a1a_0%,#2d2d2d_50%,#404040_100%)] px-8 pb-16 pt-0 text-center max-[380px]:px-4 max-[380px]:pb-12"
      style={{ minHeight: "calc(var(--vh, 1vh) * 95)" }}
    >
